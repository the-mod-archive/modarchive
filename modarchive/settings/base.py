"""
Django settings for modarchive project.
...
SECRET_KEY = os.getenv('MODARCHIVE_SECRET_KEY', '')
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'modarchive', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'modarchive.wsgi.application'
