...
class Song(models.Model):
    ...
    class Genres(models.IntegerChoices):
        ...
        OTHER_WORLD_LATIN = 54, _("World - Latin")
        OTHER_FUSION = 55, _("Fusion")
        OTHER_VOX_MONTAGE = 56, _("Vocal Montage")
        OTHER_OTHER = 57, _("Other")
        ALTERNATIVE = 58, _("Alternative")
        ALTERNATIVE_GOTHIC = 59, _("Gothic")
        ALTERNATIVE_PUNK = 60, _("Punk")
        ALTERNATIVE_METAL = 61, _("Metal - General")
        ALTERNATIVE_METAL_EXTREME = 62, _("Metal - Extreme")
        ALTERNATIVE_GRUNGE = 63, _("Grunge")
        JAZZ = 64, _("Jazz - General")
        JAZZ_MODERN = 65, _("Jazz - Modern")
        JAZZ_ACID = 66, _("Jazz - Acid")
        JAZZ_BLUES = 67, _("Blues")
        JAZZ_SWING = 68, _("Swing")
        JAZZ_BIG_BAND = 69, _("Big Band")
        HIP_HOP = 70, _("Hip-Hop")
        REGGAE = 71, _("Reggae")
        R_AND_B = 72, _("R&B")
        SOUL = 73, _("Soul")
        SKA = 74, _("Ska")
        CHRISTMAS = 75, _("Christmas")
        HALLOWEEN = 76, _("Halloween")
